...
class HSlayer_surface(nn.Module):
    ...
    def ORL_forward(self, feature, vertices, neighbor_num, neighbor_index=None):
        f_global = get_ORL_global(feature, vertices, neighbor_num, neighbor_index=neighbor_index) 
...
class HS_layer(nn.Module):
    ...
    def forward(self, vertices: "(bs, vertice_num, 3)",
        ...
        feature_fuse = self.ORL_forward(feature, vertices, neighbor_num, neighbor_index=ORL_neighbor_index)
    ...
    def ORL_forward(self, feature_fuse, vertices, neighbor_num, neighbor_index = None):
        f_global = get_ORL_global(feature_fuse, vertices, neighbor_num, neighbor_index=neighbor_index) 
...
def get_ORL_global(feature:'(bs, vertice_num, in_channel)', vertices: '(bs, vertice_num, 3)', 
                          neighbor_num:'int', neighbor_index=None):
